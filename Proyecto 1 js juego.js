import { rollthedice } from "./Funcion dado.js";
                ...
                switch (decisionselva) {
                    ...
                    switch (anochecer) {
                        ...
                        case "duermes dentro de un gran arbol":
                            ...
                            alert("luego de levantar el dado sigues tu camino y encuentras a x el cual te propone un reto")
                    ...
                    var decisiondespuesdeobjetos = prompt ("Igualmente continuas tu aventura y llegas a la puerta de una cueva por lo cual tienes opcion 1)entrar en la cueva o 2)seguir tu camino").toLowerCase()
